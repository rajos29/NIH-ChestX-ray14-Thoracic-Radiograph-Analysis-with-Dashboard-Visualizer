...
CKPT = "models/best_densenet121_multilabel.pt"
OUT_CSV = "manifest/densenet_predictions.csv"
...
def main():
    ...
    for i, label in enumerate(SELECTED_LABELS):
        ...
        out_df[f"{label}_densenet_prob"] = probs
        out_df[f"{label}_densenet_pred"] = preds

...
This project uses metadata and image data derived from the **NIH ChestX-ray dataset**, this project is using a subset of the full dataset known as "ChestX-ray8".
